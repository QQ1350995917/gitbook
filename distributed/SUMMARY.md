...
- [中间件](middleware/SUMMARY.md)
  ...
  - [kafka](middleware/kafka/SUMMARY.md)
    - [常用命令](middleware/kafka/chapter00-0.md)
    - [单机部署](middleware/kafka/chapter01-0.md)
    - [集群部署](middleware/kafka/chapter01-1.md)
    - [基本概念](middleware/kafka/chapter02-0.md)
    - [生产者参数详解](middleware/kafka/chapter03-0.md) 
