...
* [Distributed](distributed/SUMMARY.md)    
  ...
  * [kafka](distributed/middleware/kafka/SUMMARY.md)
    - [常用命令](distributed/middleware/kafka/chapter00-0.md)
    - [单机部署](distributed/middleware/kafka/chapter01-0.md)
    - [集群部署](distributed/middleware/kafka/chapter01-1.md)
    - [基本概念](distributed/middleware/kafka/chapter02-0.md)
    - [生产者参数详解](distributed/middleware/kafka/chapter03-0.md) 
