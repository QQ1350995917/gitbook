...
org.springframework.beans.factory.support.AbstractBeanFactory.doGetBean doGetBean的定义如下
...
org.springframework.aop.framework.DefaultAopProxyFactory org.springframework.aop.framework.autoproxy.AbstractAutoProxyCreator.postProcessAfterInitialization
...
*   根据beanName获取单例实例 org.springframework.beans.factory.support.DefaultSingletonBeanRegistry.getSingleton(java.lang.String, boolean)\
